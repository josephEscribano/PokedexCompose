...
class LocalDataSource @Inject constructor(
    ...
    suspend fun insertPokemonWithTipos(pokemonWithTipos: PokemonWithTipos) = pokemonDao.insertPokemonWithTipos(pokemonWithTipos)

    suspend fun deletePokemonWithTipos(pokemonWithTipos: PokemonWithTipos) = pokemonDao.deletePokemonWithTipos(pokemonWithTipos)
}